...
def main():
    ...
    if args.domain_alignment:
        ...
        print([n for n, p in model_ad.named_parameters() if not 'im_weights_estimator' in n and not any(nd in n for nd in no_decay)])
        print([n for n, p in model_ad.named_parameters() if not 'im_weights_estimator' in n and any(nd in n for nd in no_decay)])
        print([n for n, p in model_ad.named_parameters() if 'im_weights_estimator' in n])
